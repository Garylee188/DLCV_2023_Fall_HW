...
if __name__ == '__main__':
    ...
    save_dir = r"E:\DLCV-HW2\p3_result\target_svhn_3"
    ...
    F.load_state_dict(torch.load(r'E:\DLCV-HW2\p3_result\target_svhn_3\SVHN_20_Feature_Extractor.ckpt'))
    L.load_state_dict(torch.load(r'E:\DLCV-HW2\p3_result\target_svhn_3\20_Label_Predictor.ckpt'))
    ...
    visualization(
        ...
        tgt_valid_data = data["svhn_valid_set"],
        save_dir = save_dir,
        device = device
    )
