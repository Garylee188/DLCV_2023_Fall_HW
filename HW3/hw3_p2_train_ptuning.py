...
def train_eval(model, train_loader, valid_loader, test_dir, json_file_path, n_epochs, lr, save_dir, device):
    ...
    trained_layer = ['cross_attn', 'soft_prompt', 'ln_1', 'ln_2', 'ln_3']
    ...
    model.to(device)
    model.train()
    modelName = 'vl_model_huge_ptuning.pth'
...
if __name__ == '__main__':
    ...
    json_file_path = r'E:\DLCV-HW3\p2\best_pred_ptuning.json'
    ...
    state_dict = torch.load(r'E:\DLCV-HW3\p2\best_vl_model_huge_ptuning.pth')
